...
/**
 * This is the model class for table "{{user_weight_goals}}".
 *
 * The followings are the available columns in table '{{user_weight_goals}}':
 * @property integer $id
...
class UserWeightGoal extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'userWeightReadings' => array(self::HAS_MANY, 'UserWeightReading', 'user_weight_goal_id'),
		);
	}
