	...
	<form class="form-horizontal" id="profile-glucose-form" role="form">
	  	...
	  	<div class="form-group">
			...
			<div class="col-sm-10 col-md-5">
			  <input type="text" class="form-control" name="random" placeholder="Random" value="<?php echo $bmi_profile->random; ?>" required>
			</div>
		</div>
		<div class="form-group">
			<label for="fasting" class="col-sm-2 col-md-3 control-label">Fasting</label>
			<div class="col-sm-10 col-md-5">
			  <input type="text" class="form-control" name="fasting" placeholder="Fasting" value="<?php echo $bmi_profile->fasting; ?>" required>
			</div>
		</div>
		
		<?php if($bmi_profile->sugar_classification): ?>
	   	<div class="form-group">
	   		<label for="bmr" class="col-sm-2 col-md-3  control-label"></label>
		    <div class="col-sm-10 col-md-5">
		    	
		      	<?php echo $bmi_profile->sugar_classification_text; ?>
		    </div>
	  	</div>
	  	<?php endif ?>
	  	<div class="form-group">
