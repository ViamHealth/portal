	...
	<form class="form-horizontal" id="profile-bp-form" role="form">
	  	...
	  	<div class="form-group">
			...
			<div class="col-sm-10 col-md-5">
			  <input type="text" class="form-control" name="systolic_pressure" placeholder="Systolic" value="<?php echo $user->bmi_profile->systolic_pressure; ?>" required>
			</div>
		</div>
		<div class="form-group">
			<label for="diastolic_pressure" class="col-sm-2 col-md-3 control-label">Diastolic Pressure</label>
			<div class="col-sm-10 col-md-5">
			  <input type="text" class="form-control" name="diastolic_pressure" placeholder="diastolic" value="<?php echo $user->bmi_profile->diastolic_pressure; ?>" required>
			</div>
		</div>
		<div class="form-group">
			<label for="pulse_rate" class="col-sm-2 col-md-3 control-label">Pulse rate</label>
			<div class="col-sm-10 col-md-5">
			  <input type="text" class="form-control" name="pulse_rate" placeholder="Pulse Rate" value="<?php echo $user->bmi_profile->pulse_rate; ?>" required>
			</div>
		</div>
		
		<?php if($user->bmi_profile->bp_classification): ?>
	   	<div class="form-group">
