			<tbody> \
	  			...
	  			<tr class="success" id="breakfast-tr"> \
	  			 ...
	  			 \
	  			<tr class="" id="lunch-tr"> \
	  				<td class="lunch-diary">LUNCH</td> \
	  				<td class="total-calories"></td> \
	  				<td class="total-carbs"></td> \
	  				<td class="total-fat"></td> \
	  				<td class="total-proteins"></td> \
	  			...
	  			<tr class="success" id="snacks-tr"> \
	  				<td class="snacks-diary">SNACKS</td> \
	  				<td class="total-calories"></td> \
	  				<td class="total-carbs"></td> \
	  				<td class="total-fat"></td> \
	  				<td class="total-proteins"></td> \
	  			...
	  			<tr class="" id="dinner-tr"> \
	  				<td class="dinner-diary">DINNER</td> \
	  				<td class="total-calories"></td> \
	  				<td class="total-carbs"></td> \
	  				<td class="total-fat"></td> \
	  				<td class="total-proteins"></td> \
