...
<div class="row">
	...
	<div class="weight-inputs col-md-4" id="weight_goal_current_weight_div">
      ...
      <div class="">
        <p class="wval">77Kg</p>
          <input id="weight_goal_current_weight" name="weight_goal_current_weight" type="hidden" value="77">
    ...
    <div class="weight-inputs col-md-4" id="weight_goal_target_weight_div">
      ...
      <div class="">
        <p class="wval">77Kg</p>
          <input id="weight_goal_target_weight" name="weight_goal_target_weight" type="hidden" value="77">
