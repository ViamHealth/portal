...
/**
 * This is the model class for table "tbl_user_weight_readings".
 *
 * The followings are the available columns in table 'tbl_user_weight_readings':
 * @property integer $id
 ...
 */
class UserWeightReading extends VCActiveRecord
{
	...
	{
		return 'tbl_user_weight_readings';
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'userWeightGoal' => array(self::BELONGS_TO, 'UserWeightGoals', 'user_weight_goal_id'),
		);
	}
