...
/**
 * This is the model class for table "tbl_healthfile_tags".
 *
 * The followings are the available columns in table 'tbl_healthfile_tags':
 * @property integer $id
...
class HealthfileTag extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'healthfile' => array(self::BELONGS_TO, 'Healthfiles', 'healthfile_id'),
		);
	}
